...
#define BZIP2_PATH "/bin/bzip2"		/* CF_PATH_PROG(bzip2) */
...
#define ENABLE_IPV6 1		/* CF_CHECK_IPV6 */
#define ENABLE_NLS 1		/* defined if NLS is requested */
...
#define EXP_JAPANESEUTF8_SUPPORT 1	/* CF_ARG_ENABLE(japanese-utf8) */
...
#define HAVE_DCGETTEXT 1		/* AM_GNU_GETTEXT */
...
#define HAVE_FTIME 1
#define HAVE_GAI_STRERROR 1	/* CF_CHECK_IPV6 */
#define HAVE_GETADDRINFO 1		/* CF_CHECK_IPV6 */
...
#define HAVE_GETTEXT 1		/* defined if you want to use non-GNU gettext */
...
#define HAVE_LIBINTL_H 1		/* AM_GNU_GETTEXT, or cleanup from that */
...
#define HAVE_NCURSESW_TERM_H 1	/* have <ncursesw/term.h> */
...
#define LYNX_CFG_FILE "/etc/lynx/lynx.cfg"		/* $sysconfdir/lynx.cfg */
#define LYNX_CFG_PATH "/etc/lynx"		/* $sysconfdir */
#define LYNX_LSS_FILE "/etc/lynx/lynx.lss"		/* $sysconfdir/lynx.lss */
...
#define NLS_TEXTDOMAIN "lynx"		/* NLS_TEXTDOMAIN */
...
#define USE_BZLIB 1		/* AC_ARG_WITH(bzlib) */
...
#define USE_GNUTLS_FUNCS 1		/* CF_GNUTLS */
/* #undef USE_GNUTLS_INCL */		/* CF_GNUTLS */
#define USE_IDNA 1			/* CF_ARG_DISABLE(idna) */
...
#define lynx_rand arc4random		/* CF_SRAND */
#define lynx_srand (void)		/* CF_SRAND */
...
#ifdef HAVE_SYSLOG_H
#define SYSLOG_REQUESTED_URLS 1	/* CF_ARG_ENABLE(syslog) */
#endif
